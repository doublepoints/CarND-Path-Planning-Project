        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                if ( car_lane == lane ) {
                  // Car in lane.
                  car_ahead |= check_car_s > car_s && check_car_s - car_s < 90;
                } else if ( car_lane - lane == -1 ) {
                  // Car left
                  car_left |= car_s - 90 < check_car_s && car_s + 90 > check_car_s;
                } else if ( car_lane - lane == 1 ) {
                  // Car right
                  car_righ |= car_s - 90 < check_car_s && car_s + 90 > check_car_s;
                }
            }
            ...
            // Calculate distance y position on 90 m ahead.
